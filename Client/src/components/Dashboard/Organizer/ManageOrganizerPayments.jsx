...
import { fetchOrganizerPayments } from '../../../services/paymentService';
import CancelPaymentModal from "../../../components/Dashboard/CancelPaymentModal"; 

const ManageOrganizerPayments = () => {
    ...
    useEffect(() => {
        const fetchOrgPayments = async () => {
            try {
                const response = await fetchOrganizerPayments();
...
export default ManageOrganizerPayments;
